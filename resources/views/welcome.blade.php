        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-36">
                ...
                <div class="text-center">
                    <h1 class="text-balance text-4xl font-black tracking-tight text-gray-700 sm:text-6xl">MAKILALA
                        MULTI-PURPOSE COOPERATIVE</h1>
                    <p class="mt-8 text-pretty text-sm 2xl:text-lg font-medium text-gray-500">An <span
                            class="text-blue-600">Automated Credit
                            Management System</span> is a software solution designed to streamline and optimize the
                        process of
